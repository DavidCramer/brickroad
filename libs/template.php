<?php
//echo brickroad_configOption('_mainCode', 'mainCode', 'textarea', '', $Element);
...
jQuery('#fullScreen').click(function(){
    if(jQuery('#fullScreenMode').length){
        ...
        jQuery("head").append(jQuery("<link rel='stylesheet' href='<?php echo BRICKROAD_URL."styles/fullscreen.css"; ?>' id='fullScreenMode' type='text/css' media='screen' />"));
        ...
        jQuery('#brickroad_container #ce-nav ul').append('<li id="exitFSButton"><a href="#exitFS" title="Exit Fullscreen">Exit Fullscreen</a></li>').click(function(){
            jQuery('#fullScreenMode').remove();
