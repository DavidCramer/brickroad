						<?php
							...
							?>
								<label style="margin-left: 8px;"><input type="checkbox" name="<?php echo $name; ?>[<?php echo $checkboxindex; ?>]" <?php echo $sel; ?> id="<?php echo $id.'_'.$checkboxindex; ?>" value="<?php echo $checkboxValue; ?>"> <?php echo $checkboxLabel; ?></label>
							<?php 
								$checkboxindex++;
							} ?></p>
